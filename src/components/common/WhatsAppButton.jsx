/**
 * Botón flotante de WhatsApp, visible en todas las páginas del portal.
 * Abre una conversación con el número de atención de Tres Trigos.
 */
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-105 sm:bottom-6"
    >
