...
export default function ConfirmationPage() {
  ...
  const { total, numeroPedido } = state;
  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)] flex-col items-center justify-center px-4 py-10 text-center sm:px-6">
      ...
      <div className="mt-8 w-full max-w-sm rounded-xl bg-white p-5 text-left">
        ...
        <p className="mt-2 text-sm text-brand-dark">Banco XXXX · Cuenta de ahorros</p>
        <p className="font-mono text-sm text-brand-dark">000-000000-00</p>
        <p className="mt-2 text-xs text-brand-brown">
          A nombre de Tres Trigos S.A.S. · NIT XXX.XXX.XXX-X
        </p>
      </div>
